...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, CHNL_LNK, GRP_LNK, REQST_CHANNEL, SUPPORT_CHAT_ID, MAX_B_TN, REACTIONS, IS_VERIFY, HOW_TO_VERIFY
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "❆ Jᴏɪɴ Oᴜʀ ɪɴꜰɪɴɪᴛʏ ᴍᴏᴠɪᴇꜱ Cʜᴀɴɴᴇʟ ❆", url=invite_link.invite_link
                )
            ]
        ]
