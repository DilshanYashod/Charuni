...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, SUPPORT_CHAT_ID, CUSTOM_FILE_CAPTION, MSG_ALRT, PICS, AUTH_GROUPS, P_TTI_SHOW_OFF, GRP_LNK, CHNL_LNK, NOR_IMG, LOG_CHANNEL, SPELL_IMG, MAX_B_TN, IMDB, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, NO_RESULTS_MSG, IS_VERIFY, HOW_TO_VERIFY, REACTIONS
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>├ Tᴏᴛᴀʟ Usᴇʀs: <code>{search}</code>├ Tᴏᴛᴀʟ Cʜᴀᴛs: <code>{total_results}</code> ├ Usᴇᴅ Sᴛᴏʀᴀɢᴇ: <code>{message.chat.title}</code>└Fʀᴇᴇ Sᴛᴏʀᴀɢᴇ: <code>{message.from_user.mention}</code></b>"
